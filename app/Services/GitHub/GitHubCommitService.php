...
class GitHubCommitService extends GitHubService
{
    ...
    public function commitFiles(GitConfig $gitConfig, array $params): array
    {
        ...
        // Step 3 - Create blob for file to commit.
        // $blob    = $this->createBlob($$gitConfig, 'this is a test');
        // $blobSha = $blob['sha'];
     ...
     * @return array
     */
    private function createBlob(GitConfig $gitConfig, string $content): array
    {
        return $this->gitHubManager
            ->gitData()
            ->blobs()
