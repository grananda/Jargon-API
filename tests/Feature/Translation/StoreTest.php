...
class StoreTest extends TestCase
{
    ...
    /** @test */
    public function a_422_will_be_returned_when_storing_a_translation_to_with_a_non_valid_dialect()
    {
        // Given
        /** @var \App\Models\User $user */
        $user = $this->user();
    ...
    /** @test */
    public function a_422_will_be_returned_when_storing_a_translation_to_with_dialect_not_in_project()
    {
        // Given
        /** @var \App\Models\User $user */
        $user = $this->user();
