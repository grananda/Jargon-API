...
@section('content')
    ...
    <tr>
        <td bgcolor="#ffffff"
            ...
            <p style="margin: 0;">@lang('email.auth.activation.mail.p1', ['app' => $app])</p>
            <p style="margin: 0;">@lang('email.auth.activation.mail.p2')</p>
        </td>
    </tr>
    <tr>
        <td bgcolor="#ffffff"
                ...
                <tr>
                    <td style="border-radius: 3px; background: #222222; text-align: center;" class="button-td">
                        <a href="{{ $link }}"
                           ...
                           class="button-a">
                            &nbsp;&nbsp;&nbsp;&nbsp;<span
                                    style="color:#ffffff;">@lang('email.project.projects.mail.link')</span>&nbsp;&nbsp;&nbsp;&nbsp;
                        </a>
                    </td>
                </tr>
            </table>
    ...
    <tr>
        <td bgcolor="#ffffff"
            style="padding: 0 40px 40px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555; text-align: center;">
            <p style="margin: 0;">@lang('email.auth.activation.mail.p3')</p>
            <p style="margin: 0;">
                <small>{{ $link }}</small>
            </p>
        </td>
